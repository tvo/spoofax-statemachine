...
public class StateMachineParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("StateMachine");
  ...
  { 
    StateMachineParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = StateMachineParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = StateMachineParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(StateMachineParseControllerGenerated.class);
    }
  ...
  { 
    return StateMachineParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
